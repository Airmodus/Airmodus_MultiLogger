...
class DeviceManager:
    def __init__(self, main_window, data_holder, device_widgets):
    ...
    def connection_test(self):
        ...
        com_port_list = self.main_window.list_com_ports()  # Temp: access via params if MainWindow ref added, or pass as arg
